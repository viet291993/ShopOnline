				...
				<div class="left_col scroll-view">
					...
					<div class="profile clearfix">
						...
						<div class="profile_info">
							<span><s:text name="admin.hello"/></span>
					...
					<div id="sidebar-menu"
						...
						<div class="menu_section">
							<h3><s:text name="admin.system"/></h3>
							<ul class="nav side-menu">
								<li><a
									href="${pageContext.servletContext.contextPath}/admin/home"> <i
										class="fa fa-home"></i> <s:text name="admin.home"/> <span></span>
								</a></li>
								<li><a
								...
								<a
									href="${pageContext.servletContext.contextPath}/admin/catalog"><i
										class="fa fa-sitemap"></i> <s:text name="admin.catalog"/> <span></span></a></li>
								<li><a
									href="${pageContext.servletContext.contextPath}/admin/product"><i
										class="fa fa-cube"></i> <s:text name="admin.product"/> <span></span></a></li>
								<li><a
									href="${pageContext.servletContext.contextPath}/admin/transaction"><i
										class="fa fa-file-text-o"></i> <s:text name="admin.bill"/> <span></span></a></li>
							</ul>
						</div>
				...
				<div class="nav_menu">
					<nav>
						...
						<ul class="nav navbar-nav navbar-right">
							...
							<li><a href="${pageContext.servletContext.contextPath}/admin/home?request_locale=en"> <img src="images/Icon/en.png" ></a></li>
									<li><a href="${pageContext.servletContext.contextPath}/admin/home?request_locale=vi_VN"><img src="images/Icon/vi.png" ></a></li>
