	...
	<div class="wrap_header fixed-header2 trans-0-4">
		...
		<div class="wrap_menu">
			<nav class="menu">
				<ul class="main_menu">
					<li>
						<a href="${pageContext.servletContext.contextPath}/home"><s:text name="client.home"/></a>
					</li>

					<li>
						<a href="${pageContext.servletContext.contextPath}/shop"><s:text name="client.shop"/></a>
					</li>
					...
					<li>
						<a href="${pageContext.servletContext.contextPath}/about"><s:text name="client.about"/></a>
					</li>

					<li>
						<a href="${pageContext.servletContext.contextPath}/contact"><s:text name="client.contact"/></a>
					</li>
				</ul>
			</nav>
		</div>
			...
			<div class="topbar2">
				...
				<div class="topbar-child2">
					...
					<div class="topbar-language rs1-select2">
						<select class="selection-1" onchange="window.location=this.value">
							<option ${sessionScope.WW_TRANS_I18N_LOCALE=="vi_VN"?"selected":""} value="${pageContext.servletContext.contextPath}/home?request_locale=vi_VN">VIE</option>
							<option ${sessionScope.WW_TRANS_I18N_LOCALE=="en_US"?"selected":""} value="${pageContext.servletContext.contextPath}/home?request_locale=en_US">ENT</option>
						</select>
					</div>
	...
	<footer class="bg6 p-t-45 p-b-43 p-l-45 p-r-45">
		...
		<div class="t-center p-l-15 p-r-15">
			...
			<div class="t-center s-text8 p-t-20">
				Copyright © 2018 All rights reserved. | Cánh cảnh Hạ Long <i class="fa fa-heart-o" aria-hidden="true"></i>
			</div>
		</div>
	</footer>
 <!-- /footer content -->
	  ...
	  //Xóa itesm giỏ hàng shoppingCartItems
	    ...
	    function displayShoppingCartItems() {
	        if (sessionStorage["shopping-cart-items"] != null) {
	            ...
	            $(".cart-total").html("<s:text name='client.product-total'/>: "+total.toLocaleString('vi-VN')+" đ");
