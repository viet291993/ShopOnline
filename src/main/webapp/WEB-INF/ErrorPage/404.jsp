        ...
        <div class="stars">
            <div class="custom-navbar">
                ...
                <div class="navbar-links">
                    <ul>                  
                      <li><a href="${pageContext.servletContext.contextPath}/home" class="btn-request" >GO BACK HOME</a></li>
                    </ul>
                </div>
            </div>
            <div class="central-body">
                <img class="image-404" src="http://salehriaz.com/404Page/img/404.svg" width="300px">
                <a href="${pageContext.servletContext.contextPath}/home" class="btn-go-home" >GO BACK HOME</a>
            </div>
            <div class="objects">
