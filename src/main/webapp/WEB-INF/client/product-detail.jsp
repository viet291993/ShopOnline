		...
		<div class="flex-w flex-sb">
			...
			<div class="w-size14 p-t-30 respon5">
				...
				<p class="s-text8 p-t-10">
					<span class="s-text8 m-r-35"><s:text name="client.product-id"/>: <s:property value="id"/></span>
				</p>
				...
				<div class="p-t-33 p-b-60">
					...
					<div class="s-text15 w-size15 t-center">
							<s:text name="client.product-qty"/>
						</div>
				...
				<div class="p-b-45">
					<span class="s-text8 m-r-35"><s:text name="client.product-view"/>: <s:property value="view"/></span>
					<span class="s-text8"><s:text name="client.catalog"/>: <s:property value="catalog.name"/></span>
				</div>
