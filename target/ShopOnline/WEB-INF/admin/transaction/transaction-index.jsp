                  ...
                  <tbody>
                   	<s:iterator value="model" status="listStatus">
					 	 <tr>
					  	    ...
					  	    <td><fmt:formatNumber type="currency" ><s:property value="amount"/></fmt:formatNumber></td>
...
function chayNgayDi(id) {
	document.getElementById("nd").innerHTML= id;
	document.getElementById("idDelelte").action = hre.value +'/admin/transaction/'+id+'?_method=DELETE';
}
</script>
