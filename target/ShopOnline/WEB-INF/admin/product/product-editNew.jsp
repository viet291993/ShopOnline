							...
							<s:form action="product" method="post"  enctype="multipart/form-data" class="form-horizontal form-label-left" theme="simple">
							    ...
							    <%-- Tên sản phẩm --%>
							     <div class="form-group">
								    ...
								    <div class="col-md-6 col-sm-6 col-xs-12">
								        <s:textfield id="name" name="name" class="form-control col-md-7 col-xs-12" /> 
								    </div>
							    </div>
							     <div class="form-group">
							    	<div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
							    ...
							    <%-- Nội dung --%>
							     <div class="form-group">
								    ...
								    <div class="col-md-6 col-sm-6 col-xs-12">
								        <s:textarea id="content" name="content" class="form-control col-md-7 col-xs-12" /> 
								    </div>
							    </div>
							     <div class="form-group">
							    	<div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
							    ...
							    <div class="form-group">
							    	<div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
							        	...
							        	<s:reset value="Làm mới" cssClass="btn btn-warning"/>
						 			</div>
							    </div>
						  </s:form>
